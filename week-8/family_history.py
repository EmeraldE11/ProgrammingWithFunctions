...
def print_death_age(people_dict):
    ...
    for person_key in people_dict:
        ...
        name = person[0]
        death_age = int(person[3]) - int(person[2])
...
def print_marriages(marriages_dict, people_dict):
    ...
    Return: nothing
    """
    for m_key in marriages_dict:
        marriage = marriages_dict[m_key]
        wedding_year = marriage[2]
        husband = people_dict[marriage[0]][0]
        husband_age = int(wedding_year) - int(people_dict[marriage[0]][2])
        wife = people_dict[marriage[1]][0]
        wife_age = int(wedding_year) - int(people_dict[marriage[1]][2])
        print(f"{husband} {husband_age} -- {wedding_year} -- {wife} {wife_age}")
