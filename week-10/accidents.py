...
def main():
    ...
    try:
        ...
        with open(filename, "rt") as text_file:
            ...
            if perc_reduc < 0:
                raise ValueError(f"{perc_reduc} is too low, please pick a number higher than 0.")
            elif perc_reduc > 100:
                raise ValueError(f"{perc_reduc} is too high, please pick a number lower than 100.")
